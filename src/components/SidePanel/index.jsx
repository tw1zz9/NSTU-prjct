...
const SidePanel = ({ isSidePanelOpen }) => {
  ...
  return (
    <div style={{ transform: isSidePanelOpen ? `translateX(-100%)` : '' }} className={styles.root}>
      ...
      <Link to={`/${role}/calendar`} onClick={() => handleSelect('calendar')}>
        <div className={`${styles.calendar} ${selected === 'calendar' ? styles.active : ''}`}>
          ...
          <div className={styles.calendarText}>Календарь</div>
        </div>
      </Link>
